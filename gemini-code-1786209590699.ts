    ...
    <section id="intake-assessment" className="w-full bg-[#020501] py-16 px-4">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mb-8 text-[#C0BFBC]">
          Initiate your intake assessment below. To preserve practice sovereignty and telehealth safety, zero physical practice addresses are recorded or displayed.
        </p>

        {/* Primary High-Intent Conversion CTA */}
        <button
